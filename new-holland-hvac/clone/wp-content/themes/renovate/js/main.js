...
jQuery(document).ready(function($){
	...
	{
		$(".blog .post-content>a>img, .post.single .post-image img, .services-list a>img, .projects-list:not('.isotope') a>img, .re-preload>img, .wpb_single_image img").each(function(){
	...
	function sliderCaptionBoxRTL()
	{
		...
		var sliderCaption = $(".tp-revslider-mainul .tp-caption");
		if(sliderCaption.length && config.is_rtl)
		{
			if($('.header').width()==1170 && !$(".site-container").hasClass("boxed"))
			{
				var style = ".tp-revslider-mainul .tp-caption{left: 0 !important;right: " + parseInt($(".header").offset().left, 10) + "px !important;}";
