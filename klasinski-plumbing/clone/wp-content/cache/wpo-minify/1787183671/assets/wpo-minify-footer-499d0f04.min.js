...
var elementorFrontendConfig = {"environmentMode":{"edit":false,"wpPreview":false,"isScriptDebug":false},"i18n":{"shareOnFacebook":"Share on Facebook","shareOnTwitter":"Share on Twitter","pinIt":"Pin it","download":"Download","downloadImage":"Download image","fullscreen":"Fullscreen","zoom":"Zoom","share":"Share","playVideo":"Play Video","previous":"Previous","next":"Next","close":"Close"},"is_rtl":false,"breakpoints":{"xs":0,"sm":480,"md":768,"lg":1025,"xl":1440,"xxl":1600},"responsive":{"breakpoints":{"mobile":{"label":"Mobile","value":767,"default_value":767,"direction":"max","is_enabled":true},"mobile_extra":{"label":"Mobile Extra","value":880,"default_value":880,"direction":"max","is_enabled":false},"tablet":{"label":"Tablet","value":1024,"default_value":1024,"direction":"max","is_enabled":true},"tablet_extra":{"label":"Tablet Extra","value":1200,"default_value":1200,"direction":"max","is_enabled":false},"laptop":{"label":"Laptop","value":1366,"default_value":1366,"direction":"max","is_enabled":false},"widescreen":{"label":"Widescreen","value":2400,"default_value":2400,"direction":"min","is_enabled":false}}},"version":"3.11.2","is_static":false,"experimentalFeatures":{"e_dom_optimization":true,"e_optimized_assets_loading":true,"e_optimized_css_loading":true,"a11y_improvements":true,"additional_custom_breakpoints":true,"landing-pages":true,"kit-elements-defaults":true},"urls":{"assets":(document.currentScript&&document.currentScript.src?new URL("../../../../plugins/elementor/assets/",document.currentScript.src).href:"../wp-content/plugins/elementor/assets/")},"swiperClass":"swiper-container","settings":{"page":[],"editorPreferences":[]},"kit":{"active_breakpoints":["viewport_mobile","viewport_tablet"],"global_image_lightbox":"yes","lightbox_enable_counter":"yes","lightbox_enable_fullscreen":"yes","lightbox_enable_zoom":"yes","lightbox_enable_share":"yes","lightbox_title_src":"title","lightbox_description_src":"description"},"post":{"id":928,"title":"Remodels%20%E2%80%93%20Klasinski%20Plumbing%20%26%20Heating%20%E2%80%93%20Stevens%20Point%2C%20WI","excerpt":"","featuredImage":false}};/*! elementor - v3.11.2 - 22-02-2023 */
...
(function($){'use strict';$(window).on('elementor/frontend/init',function(){var swiper_slide=function(){var menu=[];jQuery('.swiper-slide').each(function(index){menu.push(jQuery(this).find('.slide-inner').attr("data-text"))});var interleaveOffset=0.5;var swiperOptions={loop:!0,speed:1000,parallax:!0,autoplay:{delay:6500,disableOnInteraction:!1,},watchSlidesProgress:!0,pagination:{el:'.swiper-pagination',clickable:!0,},navigation:{nextEl:'.swiper-button-next',prevEl:'.swiper-button-prev',},on:{progress:function(){var swiper=this;for(var i=0;i<swiper.slides.length;i++){var slideProgress=swiper.slides[i].progress;var innerOffset=swiper.width*interleaveOffset;var innerTranslate=slideProgress*innerOffset;swiper.slides[i].querySelector(".slide-inner").style.transform="translate3d("+innerTranslate+"px, 0, 0)"}},touchStart:function(){var swiper=this;for(var i=0;i<swiper.slides.length;i++){swiper.slides[i].style.transition=""}},setTransition:function(speed){var swiper=this;for(var i=0;i<swiper.slides.length;i++){swiper.slides[i].style.transition=speed+"ms";swiper.slides[i].querySelector(".slide-inner").style.transition=speed+"ms"}}}};var swiper=new Swiper(".swiper-container",swiperOptions)};var sliderBgSetting=function(){var sliderBgSetting=$(".slide-bg-image");sliderBgSetting.each(function(indx){if($(this).attr("data-background")){$(this).css("background-image","url("+$(this).data("background")+")")}})};var hero_client_slider=function(){if($(".wpo-happy-client-slide").length){$(".wpo-happy-client-slide").owlCarousel({autoplay:!0,smartSpeed:300,margin:0,loop:!0,autoplayHoverPause:!0,dots:!1,nav:!1,items:4})}};var portfolio_filter=function(){function sortingGallery(){if($(".sortable-gallery .gallery-filters").length){var $container=$('.gallery-container');$container.isotope({filter:'*',animationOptions:{duration:750,easing:'linear',queue:!1,}});$(".gallery-filters li a").on("click",function(){$('.gallery-filters li .current').removeClass('current');$(this).addClass('current');var selector=$(this).attr('data-filter');$container.isotope({filter:selector,animationOptions:{duration:750,easing:'linear',queue:!1,}});return!1})}}
sortingGallery()};var testimonials_slider=function(){if($(".testimonials-wrapper").length){$(".testimonials-wrapper").owlCarousel({autoplay:!1,smartSpeed:300,margin:40,loop:!0,autoplayHoverPause:!0,dots:!1,nav:!1,responsive:{0:{items:1,},500:{items:1,},768:{items:2,},1200:{items:2},1400:{items:3},}})}};var odometer=function(){if($(".odometer").length){$('.odometer').appear();$(document.body).on('appear','.odometer',function(e){var odo=$(".odometer");odo.each(function(){var countNumber=$(this).attr("data-count");$(this).html(countNumber)})})}};var team_slider=function(){if($(".team-slider").length){$(".team-slider").owlCarousel({autoplay:!1,smartSpeed:300,margin:0,loop:!0,autoplayHoverPause:!0,dots:!1,nav:!0,navText:['<i class="fi flaticon-back"></i>','<i class="fi flaticon-next-1"></i>'],responsive:{0:{items:1},600:{items:2},768:{items:3},1200:{items:4}}})}};var partners_slider=function(){if($(".partners-slider").length){$(".partners-slider").owlCarousel({autoplay:!0,smartSpeed:300,margin:30,loop:!0,autoplayHoverPause:!0,dots:!1,responsive:{0:{items:2},550:{items:3},992:{items:4},1200:{items:5}}})}};elementorFrontend.hooks.addAction('frontend/element_ready/wpo-plumco_hero.default',function($scope,$){hero_client_slider()});elementorFrontend.hooks.addAction('frontend/element_ready/wpo-plumco_slider.default',function($scope,$){swiper_slide()});elementorFrontend.hooks.addAction('frontend/element_ready/wpo-plumco_slider.default',function($scope,$){sliderBgSetting()});elementorFrontend.hooks.addAction('frontend/element_ready/wpo_plumco_case_filter.default',function($scope,$){portfolio_filter()});elementorFrontend.hooks.addAction('frontend/element_ready/wpo-plumco_team.default',function($scope,$){team_slider()});elementorFrontend.hooks.addAction('frontend/element_ready/wpo-plumco_testimonial.default',function($scope,$){testimonials_slider()});elementorFrontend.hooks.addAction('frontend/element_ready/wpo-plumco_funfact.default',function($scope,$){odometer()});elementorFrontend.hooks.addAction('frontend/element_ready/wpo-plumco_client.default',function($scope,$){partners_slider()})})})(jQuery);
